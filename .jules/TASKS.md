...
| AUDIT-001      | P2         | Analisar `src/` e Planejar Correções de Estrutura                  | Pendente    | 4            | AgenteJules                 | 2024-08-07      | [AUDIT-001.md](./tasks/AUDIT-001.md)                           |
| REFAC-STRUCT-001 | P3         | Mover `login-form.tsx` para `src/features/auth/components/`        | Pendente    | 1            | AgenteJules                 | 2024-08-07      | [REFAC-STRUCT-001.md](./tasks/REFAC-STRUCT-001.md)             |
| REFAC-STRUCT-002 | P3         | Mover `actions.tsx` de `src/app/(auth)/` para `src/features/auth/actions/auth.actions.ts` | Pendente    | 1            | AgenteJules                 | 2024-08-07      | [REFAC-STRUCT-002.md](./tasks/REFAC-STRUCT-002.md)             |
| REFAC-STRUCT-003 | P3         | Mover lógica de sessão de `src/lib/auth/` para `src/features/auth/lib/` | Pendente    | 1            | AgenteJules                 | 2024-08-07      | [REFAC-STRUCT-003.md](./tasks/REFAC-STRUCT-003.md)             |
| REFAC-STRUCT-004 | P3         | Mover `userRepository` para `src/features/user/db/`                | Pendente    | 1            | AgenteJules                 | 2024-08-07      | [REFAC-STRUCT-004.md](./tasks/REFAC-STRUCT-004.md)             |
| REFAC-STRUCT-005 | P3         | Mover `notificationRepository` para `src/features/notification/db/` | Pendente    | 1            | AgenteJules                 | 2024-08-07      | [REFAC-STRUCT-005.md](./tasks/REFAC-STRUCT-005.md)             |
| REFAC-STRUCT-006 | P3         | Mover `paymentRepository` para `src/features/payment/db/`          | Pendente    | 1            | AgenteJules                 | 2024-08-07      | [REFAC-STRUCT-006.md](./tasks/REFAC-STRUCT-006.md)             |
| REFAC-STRUCT-007 | P3         | Mover `productRepository` para `src/features/product/db/`          | Pendente    | 1            | AgenteJules                 | 2024-08-07      | [REFAC-STRUCT-007.md](./tasks/REFAC-STRUCT-007.md)             |
| REFAC-STRUCT-008 | P3         | Mover `partnerRepository` para `src/features/partner/db/`          | Pendente    | 1            | AgenteJules                 | 2024-08-07      | [REFAC-STRUCT-008.md](./tasks/REFAC-STRUCT-008.md)             |
| REFAC-STRUCT-009 | P3         | Mover `transactionRepository` para `src/features/transaction/db/`  | Pendente    | 1            | AgenteJules                 | 2024-08-07      | [REFAC-STRUCT-009.md](./tasks/REFAC-STRUCT-009.md)             |
| REFAC-STRUCT-010 | P3         | Mover utilitários globais de `src/utils/` para `src/lib/utils/`     | Pendente    | 1            | AgenteJules                 | 2024-08-07      | [REFAC-STRUCT-010.md](./tasks/REFAC-STRUCT-010.md)             |
...
| REFAC-01.3.1 | P4         | Mover schemas Zod `payment` para `src/features/payment/schemas/`   | Pendente    | 1            | AgenteJules                 | 2024-08-07      | [REFAC-01.3.1.md](./tasks/REFAC-01.3.1.md)                     |
| REFAC-01.3.2 | P4         | Mover casos de uso (usecases) `payment` para `src/features/payment/usecases/` | Pendente    | 1            | AgenteJules                 | 2024-08-07      | [REFAC-01.3.2.md](./tasks/REFAC-01.3.2.md)                     |
| REFAC-01.3.3 | P4         | Mover lógica de banco de dados (db/repositories) `payment` para `src/features/payment/db/` | Pendente    | 1            | AgenteJules                 | 2024-08-07      | [REFAC-01.3.3.md](./tasks/REFAC-01.3.3.md)                     |
...
| REFAC-01.3.6 | P4         | Validar feature `payment` movida (ESLint, Testes)                | Pendente    | 1            | AgenteJules                 | 2024-08-07      | [REFAC-01.3.6.md](./tasks/REFAC-01.3.6.md)                     |

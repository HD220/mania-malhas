...
|----------------|------------|--------------------------------------------------------------------|-------------|--------------|-----------------------------|-----------------|----------------------------------------------------------------|
| F07.1          | P2         | Confirmar requisitos de negócio para páginas públicas/marketing... | Bloqueado   | 1            | [Product Owner/Stakeholder] | 2024-08-01      | [F07.1.md](./tasks/F07.1.md)                                   |
| F07.2          | P3         | Criar Route Group e layout base para páginas Públicas/Marketing... | Pendente    | 1            | [A DEFINIR]                 | 2024-08-01      | [F07.2.md](./tasks/F07.2.md)                                   |
| F07            | P3         | Avaliar necessidade e, se confirmado, implementar layout para...   | Subdividido | 2            | [A DEFINIR]                 | 2024-08-01      | [F07.md](./tasks/F07.md)                                       |
...
| REFAC-01.4.1.6 | P4         | Validar feature `product` movida (ESLint, Testes)                  | Bloqueado   | 1            | AgenteJules                 | 2024-08-03      | [REFAC-01.4.1.6.md](./tasks/REFAC-01.4.1.6.md)                 |
| REFAC-01.4.5.6 | P4         | Validar feature `notification` movida (ESLint, Testes)           | Bloqueado   | 1            | AgenteJules                 | 2024-08-03      | [REFAC-01.4.5.6.md](./tasks/REFAC-01.4.5.6.md)                 |
...
| META-MIGRATE-FORMAT-001 | P0 | Migrar TASKS.md para novo formato com arquivos de detalhe...     | Subdividido | 2            | AgenteJules                 | 2024-08-05      | [META-MIGRATE-FORMAT-001.md](./tasks/META-MIGRATE-FORMAT-001.md) |

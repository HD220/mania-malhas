...
| T01 | Expansão Contínua da Cobertura de Testes (Unitários/Integração)                | Testing                     | Alto       | G            | -                  | Em Progresso                   | Foco em testes unitários para casos de uso, actions, e lógica de negócios. Testes de UI foram removidos por decisão do usuário. Manter testes existentes passando e aumentar cobertura para lógica non-UI. |
